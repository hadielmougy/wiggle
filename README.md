...
dependencies {
    ...
    implementation("io.github.hadielmougy:wiggle-client:2.1.3")
    ...
    implementation("io.github.hadielmougy:wiggle-server:2.1.3")
    ...
    implementation("io.github.hadielmougy:wiggle-postgres:2.1.3")   // PostgreSQL + H2 dialects
