...
**Current version: `0.0.1`** · Java 21+ · Apache-2.0
...
dependencies {
    ...
    implementation("io.github.hadielmougy:wiggle-client:0.0.1")
    ...
    implementation("io.github.hadielmougy:wiggle-server:0.0.1")
    ...
    runtimeOnly("io.github.hadielmougy:wiggle-postgres:0.0.1")
