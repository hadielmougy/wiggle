...
#
#   docker build -t ghcr.io/hadielmougy/wiggle:0.0.4 .
#   docker run --rm -p 8080:8080 -p 8090:8090 ghcr.io/hadielmougy/wiggle:0.0.4      # in-memory
#
...
#     ghcr.io/hadielmougy/wiggle:0.0.4
