...
public record Case(String name, boolean guarded, RetryPolicy retry, String queue,
    ...
    public static Case when(String name, RetryPolicy retry, UnaryOperator<WorkflowBuilder> body) {
    ...
    public static Case when(String name, String queue, UnaryOperator<WorkflowBuilder> body) {
