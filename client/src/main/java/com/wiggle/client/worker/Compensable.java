 ...
 * declares it, by naming the step through a {@link CompensableActivity} factory. The binder
 * verifies the pairing both ways at bind time — a declared undo without a {@code Compensable}
 * handler, or a {@code Compensable}
